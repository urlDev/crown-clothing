...
const CustomButton = ({ children, isGoogleSignIn, ...otherProps }) => (
     ...
     */
    <button className={`${isGoogleSignIn ? "google-sign-in" : "" } custom-button`} {...otherProps}> {/* we put other props so it would replace the tags in input submit in sign in component */}
